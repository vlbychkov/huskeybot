...
/help или /помощь - Вызов этой же инструкции.
/Инструкция или /instruction - 
/time или /время- Покажу текущую дату.
/info или /информация или /инфа или /инфо - Информация о моем создателе и фото его команды.
...
/random или /рандом - Случайное число до 10.
И не забывай, что все держится на соплях и многое не реализовано. 
Немного подожди и все обязательно будет!""")
	print(message.from_user.first_name)
